...
## What Changes
- Introduce a Tier1 platform model mapping Rust targets to Buck prelude OS constraints (grounded in `doc/buckal-target-example.rs` target list and explicitly covering `x86_64-apple-darwin`) and apply it to rule compatibility.
